...
var StockBonCommandeController = require("../../controllers/stock_bon_commande/stock_bon_commande.controller");

var AuthorisationMiddleware = require("../../middleware/authorisation/authorisation.middleware");

var AuthenticationMiddleware = require("../../middleware/authentication/authentication.middleware"); // Routes pour la table `stock_bon_commande`
